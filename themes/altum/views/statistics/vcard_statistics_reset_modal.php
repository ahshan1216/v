...
<div class="modal fade" id="vcard_statistics_reset_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form name="vcard_statistics_reset_modal" method="post" action="<?= url('statistics/reset') ?>" role="form">
...
<script>
    ...
    $('#vcard_statistics_reset_modal').on('show.bs.modal', event => {
