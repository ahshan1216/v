        ...
        <form action="" method="post" role="form">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input type="number" id="vcards_limit" name="vcards_limit" min="-1" class="form-control form-control-lg" value="0" required="required" />
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="vcard_blocks_limit" name="vcard_blocks_limit" min="-1" class="form-control form-control-lg" value="0" required="required" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
