...
return [
    ...
    'global.plan_settings.vcards_limit' => '%s Tabcard',
    'global.plan_settings.vcard_blocks_limit' => '%s Tabcard blocks',
    ...
    'global.plan_settings.statistics_retention' => '%s days TabCard statistics retention',
    'global.plan_settings.additional_domains_is_enabled' => 'Additional domains',
    'global.plan_settings.additional_domains_is_enabled_help' => 'You get to choose from multiple domains when creating your TabCard.',
    'global.plan_settings.password_protection_is_enabled' => 'Password protection',
    'global.plan_settings.password_protection_is_enabled_help' => 'Your TabCard can be password protected if needed.',
    'global.plan_settings.analytics_is_enabled' => 'Included analytics',
    'global.plan_settings.analytics_is_enabled_help' => 'Great TabCard analytics to see how many visitors you get.',
    'global.plan_settings.qr_is_enabled' => 'QR code builder',
    'global.plan_settings.qr_is_enabled_help' => 'Custom TabCard QR code builder.',
    'global.plan_settings.removable_branding_is_enabled' => 'Removable branding',
    'global.plan_settings.removable_branding_is_enabled_help' => 'Your TabCard will not have any of our branding on them anymore.',
    'global.plan_settings.custom_url_is_enabled' => 'Custom back-half URL',
    'global.plan_settings.custom_url_is_enabled_help' => 'You will be able to customize the link URL of your TabCard.',
    'global.plan_settings.search_engine_block_is_enabled' => 'Block search engine indexing',
    'global.plan_settings.search_engine_block_is_enabled_help' => 'You will be able to block SE (like Google) from indexing your TabCard.',
    'global.plan_settings.custom_css_is_enabled' => 'Custom CSS styling',
    'global.plan_settings.custom_css_is_enabled_help' => 'Add your own CSS to your TabCard for more customizability.',
    'global.plan_settings.custom_js_is_enabled' => 'Custom JS',
    'global.plan_settings.custom_js_is_enabled_help' => 'Add your own JavaScript code to your TabCard, like a custom tracking code, help chat..etc',
    ...
    'global.plan_settings.no_ads_help' => 'You will not see any ads in your dashboard and ads will not be shown to your visitors on your TabCard.',
    ...
    'v_vcard.password.title' => 'Password protected TabCard',
    'v_vcard.password.header' => 'Password protected TabCard',
    'v_vcard.password.subheader' => 'You must input the correct password to see the content of the TabCard. Your password will be remembered for 30 days.',
    'v_vcard.password.input' => 'Password',
    'v_vcard.password.error_message' => 'The TabCard password is incorrect!',
    'v_vcard.vcard' => 'TabCard',
    'v_vcard.share' => 'Share',

    'vcards.breadcrumb' => 'TabCard',
    'vcards.title' => 'TabCard',
    'vcards.menu' => 'TabCard',
    'vcards.header' => 'TabCard',
    'vcards.subheader' => 'A TabCard is an easy to configure public page that displays your contact data.',
    'vcards.create' => 'Create TabCard',
    'vcards.external_url' => 'View TabCard',

    'vcards.table.vcard' => 'TabCard',
    'vcards.table.stats' => 'Stats',
    'vcards.table.pageviews' => 'Pageviews',
    'vcards.table.datetime' => 'Created on',
    'vcards.no_data' => 'There are no created TabCard',
    'vcards.no_data_help' => 'Start by creating your first TabCard.',

    'vcard.breadcrumb' => 'TabCard',
    'vcard.update' => 'Settings',
    'vcard.blocks' => 'Blocks',

    'vcard.input.pageviews' => 'Pageviews',
    'vcard.input.domain_id' => 'Domain',
    'vcard.input.domain_id_help' => 'Select the domain that you\'d like to use to create your TabCard with.',
    'vcard.input.is_main_vcard' => 'Exclusive TabCard for this custom domain',
    'vcard.input.is_main_vcard_help' => 'Make this TabCard to be accessible via the index of this custom domain. Other TabCard won\'t be able to be associated with this domain after.',
    'vcard.input.url' => 'URL Alias',
    'vcard.input.url_placeholder' => 'my-page-url',
    'vcard.input.url_help' => 'The main URL that your TabCard is going to be able accessed from.',
    'vcard.input.name' => 'Name',
    'vcard.input.description' => 'Description',
    'vcard.input.description_help' => 'Short description of your TabCard.',
    'vcard.input.pixels_ids' => 'Pixels',
    'vcard.input.password' => 'Password',
    'vcard.input.password_help' => 'Require visitors to enter a password to see the content of the TabCard.',
    'vcard.input.is_enabled' => 'TabCard is active',
    'vcard.input.is_share_button_visible' => 'Display share button',
    'vcard.input.is_download_button_visible' => 'Display TabCard download button',
    'vcard.input.is_se_visible' => 'Search Engine visibility',
    'vcard.input.is_se_visible_help' => 'If disabled, the TabCard will not be indexed by search engines, such as Google or Bing.',
    'vcard.input.is_removed_branding' => 'Remove branding',
    'vcard.input.is_removed_branding_help' => 'If enabled, theTabCard won\'t show the branding of our website.',
    'vcard.input.logo' => 'Logo',
    'vcard.input.logo_help' => 'Your TabCard logo, recommended 1:1 ratio for the logo.',
    'vcard.input.favicon' => 'Favicon',
    'vcard.input.favicon_help' => 'Your TabCard favicon, recommended 1:1 ratio for the favicon.',
    'vcard.input.opengraph' => 'Opengraph',
    'vcard.input.opengraph_help' => 'Your TabCard opengraph.',
    'vcard.input.background_type' => 'Background',
    'vcard.input.background_type_preset' => 'Gradient preset',
    'vcard.input.background_type_color' => 'Color',
    'vcard.input.background_type_gradient' => 'Gradient',
    'vcard.input.background_type_image' => 'Custom image',
    'vcard.input.background_gradient_one' => 'First color',
    'vcard.input.background_gradient_two' => 'Second color',
    'vcard.input.custom_css' => 'Custom CSS',
    'vcard.input.custom_css_help' => 'Custom CSS to overwrite the already existing TabCard style.',
    'vcard.input.custom_js' => 'Custom JS',
    'vcard.input.custom_js_help' => 'You could add your own tracking javascript code to the TabCard, for example.',
    'vcard.input.font_family' => 'Font family',
    'vcard.input.font_size' => 'Font size',
    'vcard.input.theme' => 'Theme',
    'vcard.input.first_name' => 'First name',
    'vcard.input.last_name' => 'Last name',
    'vcard.input.birthday' => 'Birthday',
    'vcard.input.company' => 'Company',
    'vcard.input.job_title' => 'Job title',
    'vcard.input.pixels' => 'Pixels',
    'vcard.input.seo' => 'Seo',
    'vcard.input.advanced' => 'Advanced',
    'vcard.input.fonts' => 'Fonts',
    'vcard.input.vcard' => 'TabCard details',

    'vcard.error_message.url_exists' => 'This Tabcard URL alias is already taken by someone else.',
    'vcard.error_message.blacklisted_url' => 'This custom URL is not available for usage.',
    'vcard.error_message.blacklisted_domain' => 'This domain is blacklisted.',
    'vcard.error_message.blacklisted_keyword' => 'This custom URL is blacklisted.',
    'vcard.error_message.blacklisted_location_url' => 'This URL has been blacklisted.',
    'vcard.error_message.invalid_url' => 'This URL is invalid.',

    'vcard_create.breadcrumb' => 'Create Tabcard',
    'vcard_create.title' => 'Create Tabcard',
    'vcard_create.header' => 'Create a new Tabcard',
    'vcard_create.info' => 'You can set up more details about the TabCard after the creation.',

    'vcard_update.breadcrumb' => 'Edit Tabcard',
    'vcard_update.title' => 'Edit %s Tabcard',
    'vcard_update.header' => 'Edit %s Tabcard',

    'vcard_statistics.breadcrumb' => 'Statistics',
    'vcard_statistics.title' => 'TabCard statistics - %s',
    'vcard_statistics.menu' => 'Statistics',
    'vcard_statistics.header' => '%s statistics',
    'vcard_statistics.pageviews' => 'Pageviews',
    'vcard_statistics.visitors' => 'Visitors',

    'vcard_statistics.statistics.overview' => 'Overview',
    'vcard_statistics.statistics.overview_help' => '',
    'vcard_statistics.statistics.view_more' => 'View more',
    'vcard_statistics.statistics.country' => 'Countries',
    'vcard_statistics.statistics.country_help' => 'Discover the countries that your visitors are from.',
    'vcard_statistics.statistics.country_unknown' => 'Unknown',
    'vcard_statistics.statistics.city' => 'Cities of %s',
    'vcard_statistics.statistics.city_help' => 'Discover the cities that your visitors are from.',
    'vcard_statistics.statistics.city_unknown' => 'Unknown',
    'vcard_statistics.statistics.os' => 'Operating Systems',
    'vcard_statistics.statistics.os_help' => 'Discover the operating systems that your visitors are using.',
    'vcard_statistics.statistics.os_unknown' => 'Unknown',
    'vcard_statistics.statistics.browser' => 'Browsers',
    'vcard_statistics.statistics.browser_help' => 'Discover the browsers that your visitors are using.',
    'vcard_statistics.statistics.browser_unknown' => 'Unknown',
    'vcard_statistics.statistics.language' => 'Languages',
    'vcard_statistics.statistics.language_help' => 'Discover the browser languages that your visitors are having.',
    'vcard_statistics.statistics.language_unknown' => 'Unknown',
    'vcard_statistics.statistics.device' => 'Devices',
    'vcard_statistics.statistics.device_help' => 'Discover the devices that your visitors are using.',
    'vcard_statistics.statistics.device_unknown' => 'Unknown',
    'vcard_statistics.statistics.device_desktop' => 'Desktop',
    'vcard_statistics.statistics.device_tablet' => 'Tablet',
    'vcard_statistics.statistics.device_mobile' => 'Mobile',
    'vcard_statistics.statistics.referrer_host' => 'Referrers',
    'vcard_statistics.statistics.referrer_path' => '%s referrer paths',
    'vcard_statistics.statistics.referrer_help' => 'Discover where your traffic is coming from.',
    'vcard_statistics.statistics.referrer_direct' => 'Direct',
    'vcard_statistics.statistics.referrer_qr' => 'QR Code',
    'vcard_statistics.statistics.referrer_vcard' => 'TabCard Download',
    'vcard_statistics.statistics.utms' => 'UTMs',
    'vcard_statistics.statistics.utms_help' => 'Discover how your UTM marketing campaigns are performing.',
    'vcard_statistics.statistics.utm_medium' => '%s utm mediums',
    'vcard_statistics.statistics.utm_campaign' => '%s / %s utm sources',
    'vcard_statistics.no_data' => 'There are no statistics available for this date range',
    'vcard_statistics.no_data_help' => 'Wait until you get some traffic and come back.',

    'vcard_qr.breadcrumb' => 'TabCard QR',
    'vcard_qr.title' => 'TabCard QR code - %s',
    'vcard_qr.menu' => 'QR Code',
    'vcard_qr.header' => '%s TabCard QR code',
    'vcard_qr.subheader' => 'This QR code is meant to be downloaded, printed and placed onto where your potential visitors can see and access it.',

    'vcard_qr.configurator.foreground_color' => 'Foreground color',
    'vcard_qr.configurator.background_color' => 'Background color',
    'vcard_qr.configurator.corner_radius' => 'Corner radius',
    'vcard_qr.configurator.type' => 'QR Type',
    'vcard_qr.configurator.type_normal' => 'Normal',
    'vcard_qr.configurator.type_text' => 'Insert custom text',
    'vcard_qr.configurator.type_image' => 'Insert custom logo',
    'vcard_qr.configurator.text' => 'Custom text',
    'vcard_qr.configurator.text_color' => 'Text color',
    'vcard_qr.configurator.text_size' => 'Text size',
    'vcard_qr.configurator.image' => 'Image',
    'vcard_qr.configurator.image_size' => 'Image size',
    'vcard_qr.configurator.ecc' => 'Error correction capability',
    'vcard_qr.configurator.ecc_l' => 'L - low (7%)',
    'vcard_qr.configurator.ecc_m' => 'M - medium (15%)',
    'vcard_qr.configurator.ecc_q' => 'Q - high (25%)',
    'vcard_qr.configurator.ecc_h' => 'H - best (30%)',
    'vcard_qr.print' => 'Print',
    'vcard_qr.download' => 'Download',

    'vcard_delete_modal.header' => 'Delete TabCard',
    'vcard_delete_modal.subheader' => 'This action cannot be undone.',

    'vcard_blocks.title' => 'TabCard blocks - %s',
    'vcard_blocks.header' => '%s TabCard blocks',
    'vcard_blocks.breadcrumb' => 'TabCard blocks',
    'vcard_blocks.menu' => 'TabCard blocks',
    'vcard_blocks.pageviews' => 'Pageviews',
    'vcard_blocks.reorder' => 'Drag & drop to reorder',
    'vcard_blocks.create' => 'Add block',

    'vcard_blocks.input.name' => 'Name',
    'vcard_blocks.input.open_in_new_tab' => 'Open link in new tab',
    'vcard_blocks.input.is_enabled' => 'Block is active',
    'vcard_blocks.input.link' => 'Link URL',
    'vcard_blocks.input.phone' => 'Phone number',
    'vcard_blocks.input.email' => 'Email address',
    'vcard_blocks.input.address' => 'Full address',
    'vcard_blocks.input.facebook' => 'Facebook username',
    'vcard_blocks.input.instagram' => 'Instagram username',
    'vcard_blocks.input.twitter' => 'Twitter username',
    'vcard_blocks.input.youtube' => 'YouTube channel',
    'vcard_blocks.input.whatsapp' => 'Phone number',
    'vcard_blocks.input.tiktok' => 'TikTok username',
    'vcard_blocks.input.telegram' => 'Telegram username',
    'vcard_blocks.input.spotify' => 'Spotify username',
    'vcard_blocks.input.pinterest' => 'Pinterest username',
    'vcard_blocks.input.linkedin' => 'LinkedIn username',
    'vcard_blocks.input.snapchat' => 'Snapchat username',
    'vcard_blocks.input.twitch' => 'Twitch username',
    'vcard_blocks.input.discord' => 'Discord username',
    'vcard_blocks.input.github' => 'Github username',
    'vcard_blocks.input.facebook_messenger' => 'Facebook messenger username',
    'vcard_blocks.input.reddit' => 'Reddit username',

    'vcard_blocks.no_data' => 'There are no blocks added',
    'vcard_blocks.no_data_help' => 'Start by adding your first block.',

    'vcards_blocks.title' => 'TabCard Blocks',
    'vcards_blocks.link' => 'Link',
    'vcards_blocks.email' => 'Email',
    'vcards_blocks.phone' => 'Phone',
    'vcards_blocks.address' => 'Address',
    'vcards_blocks.facebook' => 'Facebook',
    'vcards_blocks.instagram' => 'Instagram',
    'vcards_blocks.twitter' => 'Twitter',
    'vcards_blocks.youtube' => 'YouTube',
    'vcards_blocks.whatsapp' => 'Whatsapp',
    'vcards_blocks.tiktok' => 'TikTok',
    'vcards_blocks.telegram' => 'Telegram',
    'vcards_blocks.spotify' => 'Spotify',
    'vcards_blocks.pinterest' => 'Pinterest',
    'vcards_blocks.linkedin' => 'LinkedIn',
    'vcards_blocks.snapchat' => 'Snapchat',
    'vcards_blocks.twitch' => 'Twitch',
    'vcards_blocks.discord' => 'Discord',
    'vcards_blocks.github' => 'Github',
    'vcards_blocks.facebook_messenger' => 'Facebook messenger',
    'vcards_blocks.reddit' => 'Reddit',

    'vcard_block_delete_modal.header' => 'Delete TabCard block',
    'vcard_block_delete_modal.subheader' => 'This action cannot be undone.',

    'domains.breadcrumb' => 'Custom domains',
    'domains.title' => 'Custom domains',
    'domains.menu' => 'Custom domains',
    'domains.header' => 'Custom domains',
    'domains.subheader' => 'Here you can add your own custom domain to use with your TabCard.',
    ...
    'domains.input.custom_index_url_help' => 'Redirect to a specific URL when visitors land on the index of the domain, in case you don\'t want to use the custom domain for a single TabCard.',
    ...
    'domain_delete_modal.subheader' => 'By deleting the domain, all the data associated with the domain will be lost, including all the TabCard associated with it. This action cannot be undone.',
    ...
    'projects.table.vcards' => 'View TabCard',
    ...
    'dashboard.vcards_header' => 'Latest TabCard',
    'dashboard.total_vcards' => '%s TabCard',
    ...
    'index.menu' => 'Home',
    'index.title' => 'Easy TabCard Generator',
    'index.meta_description' => '',
    'index.meta_keywords' => '',
    'index.header' => 'Easy TabCard Generator',
    'index.subheader' => 'Get your new TabCard page up and running in under 5 minutes.',
    'index.get_started' => 'Get started',
    'index.example' => 'TabCard demo',
    'index.stats' => 'Our users created %s TabCard pages.',

    'index.themes.header' => '4 themes',
    'index.themes.subheader' => 'You get 4 built-in themes that you can use right away.',

    'index.customizability.header' => 'Customizable',
    'index.customizability.subheader' => 'Custom logo, background, fonts, seo settings, password protection and so much more.',

    'index.theme_style_dark.header' => 'Dark Mode',
    'index.theme_style_dark.subheader' => 'All your TabCard support dark mode 🌙 as well.',
    ...
    'index.testimonials.subheader' => 'Verified testimonials from our customers.',
    ...
    'index.cta.subheader' => 'Easy, fast & straight to the point TabCard pages.',
    ...
    'api_documentation.vcards.breadcrumb' => 'TabCard',
    'api_documentation.vcards.title' => 'TabCard API Documentation',
    'api_documentation.vcards.header' => 'TabCard',
    'api_documentation.vcards.read_all_header' => 'Retrieve TabCard',
    'api_documentation.vcards.read_header' => 'Retrieve a TabCard',

    'api_documentation.statistics.breadcrumb' => 'TabCard statistics',
    'api_documentation.statistics.title' => 'TabCard statistics API Documentation',
    'api_documentation.statistics.header' => 'TabCard statistics',
    'api_documentation.statistics.read_header' => 'Retrieve TabCard statistics',
