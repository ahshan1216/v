        ...
        <div class="col-12 col-lg-4 mb-4">
            <div class="card pricing-card h-100" style="<?= settings()->plan_free->color ? 'border-top-color: ' . settings()->plan_free->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div class="font-weight-bold text-center text-uppercase py-2 bg-gray-100 text-gray-800 rounded"><?= settings()->plan_free->name ?></div>
                    </div>
                ...
                <div class="p-3">
                    <a href="<?= url('register?redirect=pay/free') ?>" class="btn btn-block btn-primary <?= \Altum\Middlewares\Authentication::check() && $this->user->plan_id != 'free' ? 'disabled' : null ?>"><?= l('plan.button.choose') ?></a>
                </div>
            </div>
        </div>
        ...
        >
            <div class="card pricing-card h-100" style="<?= $plan->color ? 'border-top-color: ' . $plan->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div class="font-weight-bold text-center text-uppercase py-2 bg-gray-100 text-gray-800 rounded"><?= $plan->name ?></div>
                    </div>
        ...
        <div class="col-12 col-lg-4 mb-4">
            <div class="card pricing-card h-100" style="<?= settings()->plan_custom->color ? 'border-top-color: ' . settings()->plan_custom->color : null ?>">
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mb-3">
                        <div class="font-weight-bold text-center text-uppercase py-2 bg-gray-100 text-gray-800 rounded"><?= settings()->plan_custom->name ?></div>
                    </div>
