...
<section class="admin-sidebar">
    ...
    <ul class="admin-sidebar-links">
        ...
        <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminVcards']) ? 'active' : null ?>">
            <a class="nav-link d-flex flex-row" href="<?= url('admin/vcards') ?>">
                <div class="col-1 d-flex align-items-center"><i class="fa fa-fw fa-sm fa-id-card"></i></div>
                <div class="col">
                    <span class="d-inline"><?= l('admin_vcards.menu') ?></span>
                </div>
            </a>
        </li>

        <li class="<?= in_array(\Altum\Routing\Router::$controller, ['AdminVcardsBlocks']) ? 'active' : null ?>">
            <a class="nav-link d-flex flex-row" href="<?= url('admin/vcards-blocks') ?>">
                <div class="col-1 d-flex align-items-center"><i class="fa fa-fw fa-sm fa-bars"></i></div>
                <div class="col">
                    <span class="d-inline"><?= l('admin_vcards_blocks.menu') ?></span>
                </div>
            </a>
        </li>
