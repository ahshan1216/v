    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group">
                    <label for="vcard_blocks_limit"><?= l('admin_plans.plan.vcard_blocks_limit') ?></label>
                    <input type="number" id="vcard_blocks_limit" name="vcard_blocks_limit" min="-1" class="form-control form-control-lg" value="<?= $data->plan->settings->vcard_blocks_limit ?>" />
                    <small class="form-text text-muted"><?= l('admin_plans.plan.unlimited') ?></small>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="statistics_retention" name="statistics_retention" min="-1" class="form-control form-control-lg" value="<?= $data->plan->settings->statistics_retention ?>" />
