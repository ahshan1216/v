...
<nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom border-gray-100 <?= \Altum\Routing\Router::$controller_key == 'index' ? null : 'mb-6' ?>">
    <div class="container">
                    ...
                    <?php if(settings()->users->register_is_enabled): ?>
                        <li class="nav-item">
                            <a class="nav-link text-primary" href="<?= url('register') ?>">
                                <i class="fa fa-plus fa-fw fa-sm mr-2"></i>
                                <?= l('register.menu') ?>
                            </a>
                        </li>
                    <?php endif ?>
