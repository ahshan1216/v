    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
                <div>
                    <h3 class="h5"><?= sprintf(l('vcard_statistics.statistics.city'), get_country_from_country_code($data->country_code)) ?></h3>
                    <p class="text-muted"><?= l('vcard_statistics.statistics.city_help') ?></p>
                </div>
            </div>
            ...
            <div class="mt-4">
                <div class="d-flex justify-content-between mb-1">
                    <div class="text-truncate">
                        ...
                        <span class="align-middle"><?= $row->city_name ? $row->city_name : l('vcard_statistics.statistics.city_unknown') ?></span>
                    </div>
