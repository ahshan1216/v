...
<div class="row mb-4">
    <div class="col d-flex align-items-center">
        <h1 class="h3 m-0"><i class="fa fa-fw fa-xs fa-chart-line text-primary-900 mr-2"></i> <?= sprintf(l('admin_statistics.header')) ?></h1>
...
<div class="row">
    <div class="mb-5 mb-xl-0 col-12 col-xl-3">
        <div class="nav flex-column nav-pills">
            ...
            <?php endif ?>
            <a class="nav-link <?= $data->type == 'vcards' ? 'active' : null ?>" href="<?= url('admin/statistics/vcards?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-id-card mr-1"></i> <?= l('admin_statistics.vcards.menu') ?></a>
            <a class="nav-link <?= $data->type == 'statistics' ? 'active' : null ?>" href="<?= url('admin/statistics/statistics?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-chart-line mr-1"></i> <?= l('admin_statistics.statistics.menu') ?></a>
            <a class="nav-link <?= $data->type == 'vcards_blocks' ? 'active' : null ?>" href="<?= url('admin/statistics/vcards_blocks?start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date']) ?>"><i class="fa fa-fw fa-sm fa-bars mr-1"></i> <?= l('admin_statistics.vcards_blocks.menu') ?></a>
