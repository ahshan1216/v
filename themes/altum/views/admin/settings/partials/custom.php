...
<div>
    ...
    <div class="form-group">
        <label for="head_js_vcard"><i class="fab fa-fw fa-sm fa-js text-muted mr-1"></i> <?= l('admin_settings.custom.head_js_vcard') ?></label>
        <textarea id="head_js_vcard" name="head_js_vcard" class="form-control form-control-lg"><?= settings()->custom->head_js_vcard ?></textarea>
    </div>

    <div class="form-group">
        <label for="head_css_vcard"><i class="fab fa-fw fa-sm fa-css3 text-muted mr-1"></i> <?= l('admin_settings.custom.head_css_vcard') ?></label>
        <textarea id="head_css_vcard" name="head_css_vcard" class="form-control form-control-lg"><?= settings()->custom->head_css_vcard ?></textarea>
    </div>
</div>
