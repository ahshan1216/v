...
<div class="mb-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-id-card mr-1"></i> <?= l('admin_vcards.menu') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->vcards) ?></span></div>
            </div>

            <div class="px-2 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/vcards') ?>" class="stretched-link">
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-bars mr-1"></i> <?= l('admin_vcards_blocks.menu') ?></small>

                <div class="mt-3"><span class="h4"><?= nr($data->vcards_blocks) ?></span></div>
            </div>

            <div class="px-2 d-flex flex-column justify-content-center">
                <a href="<?= url('admin/vcards-blocks') ?>" class="stretched-link">
                    <i class="fa fa-fw fa-angle-right text-gray-500"></i>
                </a>
            </div>
        </div>
