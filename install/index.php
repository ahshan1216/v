            ...
            <div class="col" id="content">
                ...
                <section id="requirements" style="display: none">
                    ...
                    <table class="table mt-5">
                        ...
                        <tr>
                            <td>/uploads/vcards/logo</td>
                            <td><?= is_writable(ROOT . 'uploads/vcards/logo') ? 'Writable' : 'Not Writable' ?></td>
                            <td>
                                <?php if(is_writable(ROOT . 'uploads/vcards/logo')): ?>
                                    <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                <?php else: ?>
                                    <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                    <?php $requirements = false; ?>
                        ...
                        <tr>
                            <td>/uploads/vcards/favicon</td>
                            <td><?= is_writable(ROOT . 'uploads/vcards/favicon') ? 'Writable' : 'Not Writable' ?></td>
                            <td>
                                <?php if(is_writable(ROOT . 'uploads/vcards/favicon')): ?>
                                    <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                <?php else: ?>
                                    <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                    <?php $requirements = false; ?>
                        ...
                        <tr>
                            <td>/uploads/vcards/background</td>
                            <td><?= is_writable(ROOT . 'uploads/vcards/background') ? 'Writable' : 'Not Writable' ?></td>
                            <td>
                                <?php if(is_writable(ROOT . 'uploads/vcards/background')): ?>
                                    <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                <?php else: ?>
                                    <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                    <?php $requirements = false; ?>
                        ...
                        <tr>
                            <td>/uploads/vcards/opengraph</td>
                            <td><?= is_writable(ROOT . 'uploads/vcards/opengraph') ? 'Writable' : 'Not Writable' ?></td>
                            <td>
                                <?php if(is_writable(ROOT . 'uploads/vcards/opengraph')): ?>
                                    <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                <?php else: ?>
                                    <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                    <?php $requirements = false; ?>
                ...
                <section id="setup" style="display: none">
                    ...
                    <form id="setup_form" method="post" action="" role="form">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Enter random value</small>
                        </div>
