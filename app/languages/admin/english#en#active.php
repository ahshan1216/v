...
return [
    'admin_vcards.title' => 'Vcards',
    'admin_vcards.header' => 'Vcards',
    'admin_vcards.menu' => 'Vcards',

    'admin_vcards.table.name' => 'Name',
    'admin_vcards.table.is_enabled' => 'Status',
    'admin_vcards.table.datetime' => 'Created on',
    'admin_vcards.table.pageviews' => 'Pageviews',
    'admin_vcards.table.vcard_blocks' => 'View vcard blocks',
    'admin_vcards.table.user' => 'User',


    'admin_vcard_delete_modal.header' => 'Delete vcard',
    'admin_vcard_delete_modal.subheader' => 'This action cannot be undone.',


    'admin_vcards_blocks.title' => 'Vcards blocks',
    'admin_vcards_blocks.header' => 'Vcards blocks',
    'admin_vcards_blocks.menu' => 'Vcards blocks',

    'admin_vcards_blocks.table.type' => 'Type',
    'admin_vcards_blocks.table.name' => 'Name',
    'admin_vcards_blocks.table.is_enabled' => 'Status',
    'admin_vcards_blocks.table.datetime' => 'Created on',
    'admin_vcards_blocks.table.value' => 'Value',
    'admin_vcards_blocks.table.pageviews' => 'Pageviews',
    'admin_vcards_blocks.table.user' => 'User',


    'admin_vcard_block_delete_modal.header' => 'Delete vcard block',
    'admin_vcard_block_delete_modal.subheader' => 'This action cannot be undone.',
    ...
    'admin_projects.table.vcards' => 'View vcards',
    ...
    'admin_domains.table.vcards' => 'Vcards',
    ...
    'admin_domains.main.custom_index_url_help' => 'Redirect to a specific url when visitors land on the index of the domain. Only works if the domain doesn\'t have a main vcard associated to it.',
    ...
    'admin_domain_delete_modal.subheader' => 'By deleting the domain, everything that is associated with the domain will be deleted, including all the associated vcards. This action cannot be undone.',
    ...
    'admin_plans.plan.vcards_limit' => 'Vcards limit',
    'admin_plans.plan.vcard_blocks_limit' => 'Vcard blocks limit',
    ...
    'admin_plans.plan.statistics_retention' => 'Vcard statistics retention (days)',
    'admin_plans.plan.statistics_retention_help' => 'How many days will the vcard statistics be kept in the database.',
    ...
    'admin_plans.plan.password_protection_is_enabled_help' => 'Enable access to password protect vcards.',
    'admin_plans.plan.analytics_is_enabled' => 'Analytics',
    'admin_plans.plan.analytics_is_enabled_help' => 'Enable analytics for vcards.',
    'admin_plans.plan.qr_is_enabled' => 'QR code builder',
    'admin_plans.plan.qr_is_enabled_help' => 'Enable QR code builder for vcards.',
    'admin_plans.plan.removable_branding_is_enabled' => 'Removable branding',
    'admin_plans.plan.removable_branding_is_enabled_help' => 'Enable ability to remove the branding from the vcards.',
    'admin_plans.plan.custom_url_is_enabled' => 'Custom back-half URL',
    'admin_plans.plan.custom_url_is_enabled_help' => 'Enable ability to choose a custom URL when creating a vcard.',
    'admin_plans.plan.search_engine_block_is_enabled' => 'Block Search Engine indexing',
    'admin_plans.plan.search_engine_block_is_enabled_help' => 'Enable ability to block search engines from indexing vcards.',
    'admin_plans.plan.custom_css_is_enabled' => 'Custom CSS',
    'admin_plans.plan.custom_css_is_enabled_help' => 'Enable ability to add custom css for each vcard. Be aware to only allow trusted people to use this feature.',
    ...
    'admin_user_view.vcards' => 'Vcards',
    'admin_user_view.vcards_blocks' => 'Vcards Blocks',
    ...
    'admin_settings.documentation' => 'Read the <a href="https://altumco.de/66vcard-docs" target="_blank">Documentation</a> to get more details on certain available configurations.',
    ...
    'admin_settings.custom.head_js_vcard' => 'Vcard head Javascript',
    'admin_settings.custom.head_css_vcard' => 'Vcard custom CSS',
    ...
    'admin_settings.ads.header_vcards' => 'Vcard header',
    'admin_settings.ads.footer_vcards' => 'Vcard page footer',

    'admin_settings.vcards.tab' => 'Vcards',
    'admin_settings.vcards.branding' => 'Branding',
    'admin_settings.vcards.branding_help' => 'This branding is used by default in the vcard pages footer. HTML can be used in this field.',
    'admin_settings.vcards.directory_is_enabled' => 'Enable the Directory system',
    'admin_settings.vcards.directory_is_enabled_help' => 'Enabling the directory system will give your users the ability to discover new vcard pages.',
    'admin_settings.vcards.domains_is_enabled' => 'Enable the Custom Domains system',
    'admin_settings.vcards.domains_is_enabled_help' => 'Enabling this will give your users the ability to add and use custom domains.',
    'admin_settings.vcards.additional_domains_is_enabled' => 'Enable the Additional Custom Domains system',
    'admin_settings.vcards.additional_domains_is_enabled_help' => 'Enabling this will give you the ability to add global domains via the admin panel that your users can use as additional domains.',
    'admin_settings.vcards.main_domain_is_enabled' => 'Enable the usage of the main domain',
    'admin_settings.vcards.main_domain_is_enabled_help' => 'Enabling this will give your users the ability to use the main domain to create vcards. This function will only work if the Custom Domains system is enabled and there is at least one global custom domain available. Even if this option is disabled, admins will still be allowed to use the main domain.',
    'admin_settings.vcards.logo_size_limit' => 'Vcards logo size limit (MB)',
    'admin_settings.vcards.favicon_size_limit' => 'Vcards favicon size limit (MB)',
    'admin_settings.vcards.opengraph_size_limit' => 'Vcards opengraph size limit (MB)',
    'admin_settings.vcards.background_size_limit' => 'Vcards background size limit (MB)',
    'admin_settings.vcards.size_limit_help' => 'You are not able to set a higher limit than your actual server upload limit.',
    'admin_settings.vcards.blacklisted_domains' => 'Blacklisted domains',
    'admin_settings.vcards.blacklisted_domains_help' => 'People will not be able to submit any URL domain that is included in this list. Comma separated values of domains.',
    'admin_settings.vcards.blacklisted_keywords' => 'Blacklisted keywords',
    'admin_settings.vcards.blacklisted_keywords_help' => 'People will not be able to use any url alias that is included in this list. Comma separated values of keywords.',
    'admin_settings.vcards.google_safe_browsing_is_enabled' => 'Google Safe Browsing API',
    'admin_settings.vcards.google_safe_browsing_is_enabled_help' => 'Check all the URLs that the user adds via their vcard to make sure that they are not malicious / dangerous sites.',
    'admin_settings.vcards.google_safe_browsing_api_key' => 'API Key',
    ...
    'admin_statistics.vcards.menu' => 'Vcards',
    'admin_statistics.vcards.header' => 'Vcards',
    'admin_statistics.vcards.chart' => 'New vcards',

    'admin_statistics.vcards_blocks.menu' => 'Vcards blocks',
    'admin_statistics.vcards_blocks.header' => 'Vcards blocks',
    'admin_statistics.vcards_blocks.chart' => 'New vcards blocks',

    'admin_statistics.statistics.menu' => 'Vcards statistics',
    'admin_statistics.statistics.header' => 'Vcards statistics',
