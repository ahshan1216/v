    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-xl-auto d-flex">
            <div>
                ...
                <?php else: ?>
                    <a href="<?= url('project-create') ?>" class="btn btn-outline-primary"><i class="fa fa-fw fa-sm fa-plus"></i> <?= l('projects.create') ?></a>
                <?php endif ?>
            </div>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <div class="d-flex align-items-center">
                                <a href="<?= url('vcards?project_id=' . $row->project_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('projects.table.vcards') ?>">
                                    <i class="fa fa-fw fa-id-card text-muted"></i>
                                </a>
                            </div>
                        </td>
