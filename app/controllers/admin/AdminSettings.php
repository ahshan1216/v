...
class AdminSettings extends Controller {
    ...
    public function ads() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                'header' => $_POST['header'],
                'footer' => $_POST['footer'],
                'header_vcards' => $_POST['header_vcards'],
                'footer_vcards' => $_POST['footer_vcards'],
            ]);
    ...
    public function custom() {
        ...
        if(!empty($_POST)) {
            ...
            $value = json_encode([
                ...
                'head_js_vcard' => $_POST['head_js_vcard'],
                'head_css_vcard' => $_POST['head_css_vcard'],
            ]);
    ...
    public function vcards() {
        ...
        if(!empty($_POST)) {
            ...
            $this->update_settings('vcards', $value);
        }
    }
