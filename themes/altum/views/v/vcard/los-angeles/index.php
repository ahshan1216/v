...
<div class="container mt-7 mb-5">
    <div class="row">
        <div class="col-12 col-md-10 col-lg-8 offset-md-1 offset-lg-2">
            <div class="card border-0 los-angeles-card">
                <div class="d-flex flex-column align-items-center justify-content-center">
                    <?php if($data->vcard->settings->logo): ?>
                        <img src="<?= UPLOADS_FULL_URL . 'vcards/logo/' . $data->vcard->settings->logo ?>" class="los-angeles-logo" loading="lazy" />
                    <?php endif ?>

                    <div class="text-center <?= $data->vcard->settings->logo ? 'mt-3' : null ?>">
                ...
                <div class="mt-4">
                    <?php foreach($data->vcard_blocks as $vcard_block): ?>
                        ...
                        ?>
                        <div class="my-3">
                            <a href="<?= sprintf($data->available_vcards_blocks[$vcard_block->type]['format'], $href) ?>" data-vcard-block-id="<?= $vcard_block->vcard_block_id ?>" target="<?= $vcard_block->settings->open_in_new_tab ? '_blank' : '_self' ?>" class="los-angeles-button text-decoration-none d-flex align-items-center" rel="nofollow">
                    ...
                    <div class="mt-4">
                        <div class="row">
                            <?php if($this->vcard->settings->is_share_button_visible): ?>
                                <div class="col">
                                    <button data-toggle="modal" data-target="#share_modal" type="button" class="btn btn-block btn-gray-100 d-flex align-items-center justify-content-center">
                            ...
                            <?php if($this->vcard->settings->is_download_button_visible): ?>
                                <div class="col">
                                    <a href="<?= $data->vcard->full_url . '?export=vcard&referrer=vcard' ?>" class="btn btn-block btn-gray-100 d-flex align-items-center justify-content-center" target="_blank">
